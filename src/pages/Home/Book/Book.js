...
const Book = () => {
    ...
    const getSinglePlan = () => {
        axios.get(`https://blooming-scrubland-16632.herokuapp.com/plans/${bookingId}`)
            .then(res => {
                ...
                <Row className="g-3">
                    <Col md={7}>
                        <div className="detail-section p-3">
                            ...
                            <div className="text-start">
                                ...
                                <div className="mb-3">
                                    <h6 className="fw-bold"><i className="fas fa-check text-success me-2"></i>INCLUDED</h6>
                                ...
                                {/* excluded  */}
                                <div>
                                    <h6 className="fw-bold"><i className="fas fa-times me-2 text-danger"></i>EXCLUDED</h6>
                                    <li>Embassy Fee</li>
                    ...
                    <Col md={5} className='booking-form'>
                        <div className="p-3 form-section">
                            <h3 className="fw-bolder">Book This Tour</h3>
                            <form onSubmit={handleSubmit(onSubmit)} className="text-start fw-bold">
                                ...
                                <br />
                                <input style={{ backgroundColor: '#D14141' }} className="text-light" type="submit" value="Confirm Booking" />
                            </form>
                        </div>
                    </Col>
                </Row>
